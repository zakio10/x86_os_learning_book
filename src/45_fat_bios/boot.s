...
entry:
        ...
        ;---------------------------------------
        jmp ipl                                 ;0x00( 3) IPL(Initial Program Loader)(ブートプログラム)へジャンプ
        times   3 - ($ - $$) db 0x90
...
.real:  mov     ax, 0x0000
        ...
        outp    0xA0, 0x11                      ;out(0xA0, 0x11); //SLAVE.ICW1 = 0x11;
        outp    0xA1, 0x28                      ;out(0xA1, 0x28); //SLAVE.ICW2 = 0x28;
        outp    0xA1, 0x02                      ;out(0xA1, 0x02); //SLAVE.ICW3 = 0x02;
        outp    0xA1, 0x01                      ;out(0xA1, 0x01); //SLAVE.ICW4 = 0x01;
...
read_file:
        ...
        ;ルートディレクトリのセクタを読み込む
        ;---------------------------------------
        mov     bx, 32 + 256 + 256              ;BX = ディレクトリエントリの先頭セレクタ
...
;********************************************************************************************************
        ...
        dd      TO_REAL_MODE                    ;リアルモード移行プログラムアドレス

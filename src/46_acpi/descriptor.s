...
;グローバルディスクリプタテーブル
;********************************************************************************************************
GDT:            dq  0x_0000_0000_0000_0000                              ;NULL
.cs_kernel:     dq  0x_00CF_9A00_0000_FFFF                              ;CODE 4G
.ds_kernel:     dq  0x_00CF_9200_0000_FFFF                              ;DATA 4G
.cs_bit16:      dq  0x_000F_9A00_0000_FFFF                              ;コードセグメント(16ビットセグメント)
.ds_bit16:      dq  0x_000F_9200_0000_FFFF                              ;データセグメント(16ビットセグメント)
.ldt:           dq  0x_0000_8200_0000_0000                              ;LDTディスクリプタ
.tss_0:         dq  0x_0000_8900_0000_0067                              ;TSSディスクリプタ
.tss_1:         dq  0x_0000_8900_0000_0067                              ;TSSディスクリプタ
.tss_2:         dq  0x_0000_8900_0000_0067                              ;TSSディスクリプタ
.tss_3:         dq  0x_0000_8900_0000_0067                              ;TSSディスクリプタ
.tss_4:         dq  0x_0000_8900_0000_0067                              ;TSSディスクリプタ
.tss_5:         dq  0x_0000_8900_0000_0067                              ;TSSディスクリプタ
.tss_6:         dq  0x_0000_8900_0000_0067                              ;TSSディスクリプタ
.call_gate:     dq  0x_0000_EC04_0008_0000                              ;386コールゲート(DPL=3, count=4, SEL=8)
.end:
...
;ローカルディスクリプタテーブル
;********************************************************************************************************
LDT:            dq  0x_0000_0000_0000_0000                              ;NULL
.cs_task_0:     dq  0x_00CF_9A00_0000_FFFF                              ;CODE 4G
.ds_task_0:     dq  0x_00CF_9200_0000_FFFF                              ;DATA 4G
.cs_task_1:     dq  0x_00CF_FA00_0000_FFFF                              ;CODE 4G
.ds_task_1:     dq  0x_00CF_F200_0000_FFFF                              ;DATA 4G
.cs_task_2:     dq  0x_00CF_FA00_0000_FFFF                              ;CODE 4G
.ds_task_2:     dq  0x_00CF_F200_0000_FFFF                              ;DATA 4G
.cs_task_3:     dq  0x_00CF_FA00_0000_FFFF                              ;CODE 4G
.ds_task_3:     dq  0x_00CF_F200_0000_FFFF                              ;DATA 4G
.ds_task_4:     dq  0x_00CF_F200_0000_FFFF                              ;DATA 4G
.ds_task_5:     dq  0x_00CF_F200_0000_FFFF                              ;DATA 4G
.ds_task_6:     dq  0x_00CF_F200_0000_FFFF                              ;DATA 4G
.end:
